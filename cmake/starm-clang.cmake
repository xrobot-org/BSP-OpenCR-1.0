...
if(NOT DEFINED OPENCR_LINKER_SCRIPT)
  if(OPENCR_IMAGE STREQUAL "app")
    set(OPENCR_LINKER_SCRIPT "${CMAKE_SOURCE_DIR}/STM32F746XX_APP.ld")
  elseif(OPENCR_IMAGE STREQUAL "bootloader")
    set(OPENCR_LINKER_SCRIPT "${CMAKE_SOURCE_DIR}/STM32F746XX_BOOTLOADER.ld")
  else()
    set(OPENCR_LINKER_SCRIPT "${CMAKE_SOURCE_DIR}/STM32F746XX_FLASH.ld")
  endif()
endif()
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -T \"${OPENCR_LINKER_SCRIPT}\"")
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,-Map=${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections -z nostart-stop-gc")
